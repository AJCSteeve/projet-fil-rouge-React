...
import {
    ...
    faFutbolBall,
    faGuitar,
    faIceCream, faLocationPin,
    faMicrophone,
    faMoneyBills, faShoppingCart,
    faTents,
    faTheaterMasks
} from "@fortawesome/free-solid-svg-icons";
import PaymentButton from "../payment/PaymentButton"; // Import useLocation
...
const FetchTicketsAll = () => {
    ...
    //Partie venant de Purchase Début
